...
public class viewBlogs extends AppCompatActivity {
    ...
    String url="",ip="";
    ArrayList<String> date,blog,photo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RequestQueue queue = Volley.newRequestQueue(viewBlogs.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    blogs.setAdapter(new Custom3(viewBlogs.this,date,blog,photo));
//                    comments.setOnItemClickListener(View_Comment.this);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(viewBlogs.this, "err"+error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
