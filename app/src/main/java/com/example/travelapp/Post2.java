...
public class Post2 extends AppCompatActivity implements AdapterView.OnItemClickListener {
ListView posts;
ImageView photo;
Button add;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RequestQueue queue = Volley.newRequestQueue(Post2.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    posts.setAdapter(new Custom3(Post2.this,date,post,photos));
                    posts.setOnItemClickListener(Post2.this);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Post2.this, "err"+error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
...
params.put("userid",sp.getString("lid",""));
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),Post_Photo.class));
